...
public class DependencyTreeResolutionListener implements ResolutionListenerForDepMgmt {
	...
	/*
	 * @see org.apache.maven.artifact.resolver.ResolutionListener#
	 * startProcessChildren (org.apache.maven.artifact.Artifact)
	 */
	public void startProcessChildren(final Artifact artifact) {
		...
		if (!currentNode.getArtifact().equals(artifact)) {
			throw new IllegalStateException(
					"Artifact was expected to be " + currentNode.getArtifact() + " but was " + artifact);
		}
	 ...
	 */
	public void omitForNearer(final ResolutionNode omittedNode, final ResolutionNode keptNode) {
		...
		if (!omittedNode.getArtifact().getDependencyConflictId()
			...
			throw new IllegalArgumentException(
					"Omitted artifact dependency conflict id " + omittedNode.getArtifact().getDependencyConflictId()
	 ...
	 */
	public void updateScope(final ResolutionNode resolutionNode, final String scope) {
		if (!artifactFilter.include(resolutionNode.getArtifact())) {
			return;
		}
	...
	/*
	 * @see org.apache.maven.artifact.resolver.ResolutionListener#
	 * updateScopeCurrentPom (org.apache.maven.artifact.Artifact,
	 * java.lang.String)
	 */
	public void updateScopeCurrentPom(final ResolutionNode resolutionNode, final String scopeIgnored) {
		if (!artifactFilter.include(resolutionNode.getArtifact())) {
			return;
		}
		log("updateScopeCurrentPom: artifact=" + resolutionNode.getArtifact() + ", scopeIgnored=" + scopeIgnored);
	...
	/*
	 * @see org.apache.maven.artifact.resolver.ResolutionListener#
	 * selectVersionFromRange (org.apache.maven.artifact.Artifact)
	 */
	 ...
	 */
	public void restrictRange(final Artifact artifact, final Artifact replacement, final VersionRange versionRange) {
